...
These three public HAT sites are listed on <a href='https://hat.bc.ca/community-based-restoration'>HAT's webpage</a>. 
Spatial data for Oak Haven shows polygons of restoration and species locations, but <em>does not respond to filters</em>.
The layer menu is used to toggle spatial data layers on. 
The measuring tool can be used to measure distance between or within sites.  
The geolocation map can toggle your location, though permission has to be given to browser to access location data. Points can be added and saved to the console (right-click map > Inspect > Console > copy coordinates). Hosted as <a href='https://wendyanthony.github.io/HAT/WebMap/HAT_spatial_site_map_geoloc_draw.html'>a stand-alone web map</a>
")
```
