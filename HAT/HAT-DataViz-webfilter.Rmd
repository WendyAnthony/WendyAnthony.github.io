...
sd_crew_vol_inv_top5 <- SharedData$new(data = crew_vol_inv_top5, group = "crew_all_group")
...
HTML("<strong>Created and Coded for HAT by Wendy Anthony 2026-01-18 12:03</strong>")
...
p(class = "container", class = "value", summarywidget(sd_crew_vol, column = "Crew_Hours", statistic = "sum"), span(class = "caption", "= Biomass Removed (m3)"))
...
### **Box plots Top 5 Invasive Species Biomass** 
...
#  scale_fill_manual(values = custom_colours_3) +
  labs(
      title='Top 5 Invasive Species Biomass Removed',
      fill = "",
      x = "", 
...
### **Jitter-Box plots Top 5 Invasive Species Biomass** 
```{r inv-biomass-jitter-box-inv-top5}
# create custom colour-blind-friendly palette
# custom_colours_3 <- c("Invasive" = "#fc8d62", 
#                     "Native" = "#66c2a5", 
#                     "MixedGrass" = "#8da0cb")
...
### **Jitter-Box plots Invasive Grass Species Biomass** 
```{r inv-biomass-jitter-box-inv}
# create custom colour-blind-friendly palette
# custom_colours_3 <- c("Invasive" = "#fc8d62", 
#                     "Native" = "#66c2a5", 
#                     "MixedGrass" = "#8da0cb")
ggplotly(
  ggplot(sd_crew_vol_grs, aes(x = reorder(Invasive_Species_Cleared, desc(Invasive_Species_Cleared)), y = Biomass_Removed_m3, fill = Site, 
                                                          text = paste("Year:", Year,
                                                          "\nSite:", Site))) + 
  geom_boxplot() +
  geom_jitter() +
...
#  scale_fill_manual(values = custom_colours_3) +
  labs(
      title='Invasive Grass Species Biomass Removed',
      fill = "",
      x = "", 
      y = "Biomass Removed (m3)"), 
  tooltip = "text",
...
### **Box plots All Species Removal Biomass** 
```{r inv-biomass-box}
# create custom colour-blind-friendly palette
# custom_colours_3 <- c("Invasive" = "#fc8d62", 
#                     "Native" = "#66c2a5", 
...
### **Jitter-Box plots Invasive Biomass** 
```{r inv-biomass-jitter-box}
# create custom colour-blind-friendly palette
# custom_colours_3 <- c("Invasive" = "#fc8d62", 
#                     "Native" = "#66c2a5", 
#                     "MixedGrass" = "#8da0cb")
...
### Datatable Crew, Volunteer Hours & Biomass
