...
ggplotly(
  ...
  theme(legend.position ="bottom") + 
    scale_fill_manual(values = custom_colours_years) +
      labs(
          title = "Top 5 Invasive Species Biomass (m3) Removed At Each Site", 
          x = "",   
          y = "Biomass Removed (cubic metres)",   
          fill = ""
          ) +
...
# <img src="https://images.squarespace-cdn.com/content/v1/5e3c5b7e5460c55405a6d4d6/a8c2fb30-96fd-4042-925f-e76c7040dce6/Black+Logo+2.png?format=5w">
     title <- '<p style="text-align: center; height: 14px; "><img src = "images/HAT-logo-ss.png", width = 100><span style="font-size:12px;font-weight:bold; background-color: rgba(255, 255, 255, 0.9;");>GOE Monitoring HAT Covenant Sites Map</span></p>'
...
#                "<img src = 'https://images.squarespace-cdn.com/content/v1/5e3c5b7e5460c55405a6d4d6/a8c2fb30-96fd-4042-925f-e76c7040dce6/Black+Logo+2.png?format=5w'>",  "<br>","<br>",
    ...
    '<table style="border: 0px solid black; vertical-align: top; font-size: 80%;">',
...
### Datatable
```{r data-table-map}
htmltools::h5("HAT's 3 Public Sites Datatable")
htmltools::br()
