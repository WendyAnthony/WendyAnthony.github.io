...
sd_crew_vol_inv_top5 <- SharedData$new(data = crew_vol_inv_top5, group = "top5_group")
...
HTML("<strong>Created and Coded for HAT by Wendy Anthony 2026-01-19 10:00</strong>")
...
ggplotly(
  ggplot(sd_crew_vol_inv_top5, aes(x = reorder(Invasive_Species_Cleared, desc(Invasive_Species_Cleared)), y = Biomass_Removed_m3, fill = as.factor(Year), 
                                                          text = paste("Year:", Year,
                                                          "\nSite:", Site,
