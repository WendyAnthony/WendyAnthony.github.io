...
HTML("
     ...
     <br> * daily crew hours
     <br> * daily invasive species removed (cubic metres)
     ...
     <br> * volunteer work hours
     <br> * volunteer invasive species removal
     <br> * added to Matson Work Crew data
...
* Comparing monitoring results from multiple restoration projects requires consistent measurements of vegetation composition (e.g. native and exotic species cover), which may help identify responses to stressors affecting already compromised and rare GOE.<br> 
* Representing data in a visual manner can help make complex data more understandable than a tables of numbers, and may reveal patterns or trends resulting from different restoration management actions.<br> 
* Data visualization can represent abstract information visually,  allow for data exploration and analysis, help model restoration management alternatives, create 'data-based story-telling', and communicate potential insights to help make effective restoration management decisions; RMarkdown-generated reports can help create reproducible research.
<br><br>

<strong>Project Goals and Overall Purpose</strong><br>
* I propose to create a customized coding and reporting tool for non-coders, with tutorial instructions, using open-source R packages to format and interactively visualize data collected at multiple sites for HAT Garry Oak Ecosystem Monitoring (GOEM) Program.<br> 
* Based on questions HAT wants the tool to help answer about the data, it will provide an interactive way to communicate information about the data and help determine any patterns through analysis.<br> 
* All parts of this project were created using R code in RMarkdown, to showcase some visualizations tools and reports. <br>
* This may also be a method model to compare multiple GOEM Projects using the same measurement parameters.
<br><br>

<strong>Project Objectives</strong><br>
* Analyze and transform collected data<br>
* Write data visualization code<br>
* Create interactive data visualization tools<br>
...
* RMarkdown Data Processing Document Tool<br>
* Customizations<br>
* Create Customized Functions for HAT<br>
* Data Visualizations<br>
* Interactive Browser-based Data Viz Tool<br>
* Tutorials for using Data visualization Tools<br>
* Best practises for data files<br>
* Written Report: Due 2026-04-15; publish in online journal Ecorestoration: RNS Technical Series<br>
* Project Presentation: By mid-May 
  ")
```
...
<strong>Density plots</strong> show frequency distribution shape of highest concentration of values (like a smooth histogram); could be used to budget time i.e. how long crews usually spend at each site; <strong><em>Density plots only respond to Site filter</em></strong>. <em>Note: There is still some missing data for 2022 & 2025</em>.  
...
### **Histogram Crew Hours** 
```{r inv-density-hours-hist}
custom_colours_Site_9 <- c(
			"Matson" = "#f8766d", 
      "Oak Haven" = "#619cff",
			"Purple Sanicle" = "#db72fb",
...
ggplotly(
  ggplot(sd_crew_vol) +
    geom_histogram(bins = 70, aes(x = Crew_Hours, fill = Site), 
                   alpha = 0.5, position = "identity") + 
    labs(title = "Distribution of amounts of work hours each site visit",
         x = "Work Hours",
         fill ="") +
    scale_fill_manual(values = custom_colours_Site_9) +
  theme_minimal() 
...
htmltools::HTML("
  ...
  <em>Note: There is still some missing data for 2022 & 2025</em>")
```
...
```{r}
htmltools::HTML("
Box plots show variation of biomass removed for top 5 invasive species at each site, including median, variance & outliers (Bear Hill didn't differentiate any species from 'mixed species', thus doesn't show). <em>Note: There is still some missing data for 2022 & 2025.</em> 
...
```{r}
htmltools::HTML("
Multiple facets compare 8 sites for invasive species biomass removed (Bear Hill didn't differentiate any species from 'mixed species', thus doesn't show). <em>Note: There is still some missing data for 2022 & 2025</em> 
  ")
```
