...
library(htmlwidgets) # save web map
```
...
```{r data-import-st, data-download, include = FALSE}
## Import spatial Data
...
```{r shape-data-dropz, include = FALSE}
...
```{r spatial-subset-save, include = FALSE}
