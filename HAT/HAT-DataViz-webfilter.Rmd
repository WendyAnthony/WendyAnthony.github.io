...
HTML("<strong>Created and Coded for HAT by Wendy Anthony 2026-01-22 10:09</strong>")
...
```{r}
htmltools::HTML("
Crew data was collected for labour hours, invasive species and biomass removed. Density plots show highest concentration of values, and only respond to Site filter. <em>Note: There is still some missing data for 2025</em>.  
...
ggplotly(
  ggplot(sd_crew_vol, aes(x = Crew_Hours)) +
    ...
    labs(title = "Distribution of hours crew worked each site visit",
         caption = "test",
         x = "Crew Work Hours") +
  theme_minimal() 
  ) 
...
```{r}
htmltools::HTML("
Box plots show variation of biomass removed for top 5 invasive species at each site, including means, variance & outliers. <em>Note: There is still some missing data for 2025.</em> 
