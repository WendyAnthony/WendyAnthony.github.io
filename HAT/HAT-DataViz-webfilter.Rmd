...
HTML("
     ...
     <br> * <strong>Datasets</strong>: <em>Restoration Crew Data.xlsx</em>: Apr 2022-Sep 2025; Sites Daily; Sites Summary; Top Invasives Variance; Top Invasives Site
     <br><br>
     ...
     <br> * <strong>Datasets</strong>: <em>Matson Mattocks Field Logs</em>: Apr 2022-Sep 2025; Sites Daily; Top Invasives Variance
     <br><br>
     ...
     <br> * <strong>Metrics</strong>: Apr 2022-Sep 2025; Top 5 invasives, Hours per m3 Biomass, staff hours, biomass removed
...
<strong>Frequency plots</strong> show the distribution shape of the highest concentration of values (like a smooth histogram); could be used to budget time i.e. how long crews usually spend at each site; <em>Note: Some missing data for fall 2025</em>.  
...
htmltools::HTML("
  ...
  <em>Note: Some missing data for fall 2025</em>")
```
...
```{r}
htmltools::HTML("
Box plots show variation of biomass removed for top 5 invasive species at each site, including median, variance & outliers (Bear Hill didn't differentiate any species from 'mixed species', thus doesn't show). <em>Note: Some missing data for fall 2025.</em> 
...
ggplotly(
  ...
  labs(
      title='Species Richness Count at Oak Haven and Matson by Site, Year, Treatment & Type',
      fill = "",
      x = "Treatment", 
      y = "Species Count") +
  theme(axis.text.x = element_text(angle = 0, vjust = 1, hjust=1, size = 7)), 
