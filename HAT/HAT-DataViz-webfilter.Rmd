...
#p(class = "container", class = "value", summarywidget(sd_crew, column = "Labour_Bio_Hr_Ratio", statistic = "sum"), span(class = "caption", "= hours of labor/m3 biomass", digits = 2))
#p(class = "container", class = "value", summarywidget(sd_crew, column = "Labour_Hr_Bio_Ratio", statistic = "sum"), span(class = "caption", "= m3 biomass/hours of labor", digits = 2))
htmltools::br()
htmltools::hr(style = "border: 0.5px solid grey; width: 250px; margin: auto;")
h4("Filters")
# Create a filter input
