...
### Oak Haven Interactive Map spatial Data
```{r}
map_all <- leaflet() %>%
  # addTiles() %>%
  addProviderTiles("Esri.WorldImagery") %>%
  ...
  addLayersControl(
    overlayGroups = c("2024 ShinyG Burning Priorities", "2024 Invasive Species Removed", "2024 Invasive Species Patches", "2024 Invasive Species Points"),
