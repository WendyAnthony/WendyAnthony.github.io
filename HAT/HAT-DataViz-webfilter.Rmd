...
#############################################
  ...
  hideGroup(c("2024 ShinyG Burning Priorities", "2024 Invasive Species Removed", "2024 Invasive Species Patches", "2024 Invasive Species Points", "OH Spatial Polygon Color Legend")) %>%
  addScaleBar() %>%
...
map_all <- leaflet() %>%
  ...
  addLegend(
              ...
              labels = c("2025 Completed polygons", "2025 Experimental test plot points", "2024 Invasive Species Removed", "2024 Invasive Species Patches", "2024 ShinyG Burning Priorities", "2024 Invasive Species Points"),
              title = "OH Spatial Data",
              group = "Spatial Polygon Color Legend"
              ) %>%
  ...
  addMeasure(
    ...
    completedColor = "#BB5566") %>% 
  addLayersControl(
    overlayGroups = c("2025 Completed polygons", "2025 Experimental test plot points", "2024 Invasive Species Removed", "2024 Invasive Species Patches", "2024 ShinyG Burning Priorities", "2024 Invasive Species Points"),
