...
```{r}
HTML("
<strong>Data visualization charts</strong> have been created for each type of data. <strong>Dataset tables</strong> are included with each dataset associated with tabs in header.
")
```
...
HTML("
     ...
     <br> * daily crew hours
     <br> * daily invasive species removed (cubic metres)<br><br>
     2. <strong>Matson Mattocks Field Logs</strong> 
     <br> * volunteer work hours
     <br> * volunteer invasive species removal
     <br> * added to Matson Work Crew data<br><br>
     3. <strong>Cover Data 2024-2025</strong> 
     <br> * Mean % Cover
     <br> * For Native vs Invasive
     <br> * For Treated vs Untreated
     <br> * Species Richness
     ")
```
...
HTML("
  ...
  * Tabs in the top header host different data visualization charts and datatables
  * Each tab using different data and responsive to different filters<br>
  ...
  * Data visualization can be zoom-focused by with a click-drag over a certain area
...
```{r}
HTML("
  <br>This interactive data visualization tool was created as a final project for University of Victoria Restoration of Natural Ecosystems ER390, with HAT as a community partner, supervised by Nancy Shackelford.<br><br>
  ")
```
...
```{r}
htmltools::HTML("
Box plots show variation of biomass removed for top 5 invasive species at each site, including median, variance & outliers (Bear Hill didn't differentiate any species from 'mixed species', thus doesn't show). <em>Note: There is still some missing data for 2025.</em> 
...
ggplotly(
  ...
  scale_fill_manual(values = custom_colours_Site_2) +
  labs(
        title = "Mixed Grasses Mean % Cover at Matson & Oak Haven 2024-2025",     
        x = "",   
        y = "Mean % cover",
        fill = ""
        ) +
