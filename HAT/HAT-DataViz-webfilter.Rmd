...
```{r}
htmltools::HTML("
This map shows 3 public sites listed on <a href='https://hat.bc.ca/community-based-restoration'>HAT's webpage</a>, all other sites are on private, non-public land with location protected for privacy. Click map markers to open pop-up windows with information about each site. Images only work when used online.
                ")
```
...
leaflet(sd_sites) %>%
      ...
      addCircleMarkers(
        ...
        "<b>Top 5 Invasives:</b> ", HAT_sites_HAT$Top_5_Invasives, "<br><br>",
    ...
    # Hours per Biomass (m3)
      '<tr style="vertical-align: top;">',
        ...
        '<td>', HAT_sites_HAT$Hours_per_Biomass_2022, '</td>',
        '<td>', HAT_sites_HAT$Hours_per_Biomass_2023, '</td>',
        '<td>', HAT_sites_HAT$Hours_per_Biomass_2024, '</td>',
        '<td>', HAT_sites_HAT$Hours_per_Biomass_2025, '</td>',
      '</tr>',
    
    # Staff Hours
      '<tr style="vertical-align: top;">',
        '<td style="vertical-align: top;"><b>Staff Hours: </b></td>',
        '<td>', HAT_sites_HAT$Staff_Hours_2022, '</td>',
        '<td>', HAT_sites_HAT$Staff_Hours_2023, '</td>',
        '<td>', HAT_sites_HAT$Staff_Hours_2024, '</td>',
        '<td>', HAT_sites_HAT$Staff_Hours_2025, '</td>',
      '</tr>',
    
    #Biomass Removed (m3)
      '<tr style="vertical-align: top;">',
        '<td style="vertical-align: top;"><b>Biomass Removed (m3): </b></td>',
        '<td>', HAT_sites_HAT$Biomass_2022, '</td>',
        '<td>', HAT_sites_HAT$Biomass_2023, '</td>',
        '<td>', HAT_sites_HAT$Biomass_2024, '</td>',
        '<td>', HAT_sites_HAT$Biomass_2025, '</td>',
      '</tr>',
    '</table>',
    "<br><br>",
            "<figure><span style='text-align: center; font-style:italic; font-size: 9px'><img src = '", HAT_sites_HAT$Site_Image, "'> <figcaption>Image: https://hat.bc.ca/community-based-restoration </figcaption></span></figure>", "<br>"
