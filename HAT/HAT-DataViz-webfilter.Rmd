...
map_all <- leaflet() %>%
  ...
  addPolygons(data = OH_2024_ShinyG_Burning_Priorities_dropz,
              ...
              #fillColor = "blue",
              fillOpacity = 0.8,
              popup = paste0("Area Number: ", OH_2024_ShinyG_Burning_Priorities_dropz$AreaNumber)) %>% # Optional: add popups
  ...
  addCircleMarkers(data = OH_2024_Invasive_Species_Points_dropz,
              ...
              fillOpacity = 0.5,
              radius = 2,
              popup = paste0("Description: ", OH_2024_Invasive_Species_Points_dropz$Descript)
              ) %>%
  ...
  addCircleMarkers(data = OHP_2025_Experimental_test_plots_dropz,
              ...
              fillOpacity = 0.5,
              radius = 2,
              popup = paste0("Description: ", OHP_2025_Experimental_test_plots_dropz$Descript)) %>%
  setView(-123.4471, 48.56419, 17) %>%
  addLayersControl(
    overlayGroups = c("2024 ShinyG Burning Priorities", "2024 Invasive Species Removed", "2024 Invasive Species Patches", "2024 Invasive Species Points", "2025 Completed polygons", "2025 Experimental test plot points"),
    options = layersControlOptions(collapsed = FALSE) # Makes control box always visible
  ) %>%
...
#############################################
  ...
  addLayersControl(
    overlayGroups = c("2024 ShinyG Burning Priorities", "2024 Invasive Species Removed", "2024 Invasive Species Patches", "2024 Invasive Species Points", "2025 Completed polygons", "2025 Experimental test plot points"),                        
    options = layersControlOptions(collapsed = TRUE) # Makes control box always visible FALSE or closed TRUE
  ) %>%
