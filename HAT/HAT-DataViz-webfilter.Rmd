...
HTML("<strong>Created and Coded for HAT by Wendy Anthony 2026-01-21 12:50</strong>")
...
#  geom_line(stat = "identity", position = "identity") +
  ...
  theme(plot.title = element_text(hjust = 0)) +
   scale_color_manual(values = c("#b15928","#ffff99","#6a3d9a","#cab2d6","#ff7f00","#33a02c","#a6cee3","#b2df8a", "#cab2d6")) +
    #scale_fill_manual(values = custom_colours_3) +
        labs(title='Biomass removal (cubic metres) by HAT Crew & Volunteers',
          # subtitle='2025',
#          caption = "Chart by Wendy Anthony \n 2025-11-29", fill = "Biomass_Removed_m3",
...
ggplot(sd_crew, aes(x = reorder(Site, desc(Site)), y = Labour_Hr_Bio_Ratio, fill = as.factor(Year), 
  ...
  theme(plot.title = element_text(hjust = 0)) +
  labs(
       title='Total Work Crew Hours Required to Remove each cubic metre of Biomass (cost)',
      fill = "Year",
      x = "", 
