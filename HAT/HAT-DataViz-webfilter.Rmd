...
")
# <strong>Frequency plots</strong> show the distribution shape of the highest concentration of values (like a smooth histogram); could be used to budget time i.e. how long crews usually spend at each site; 
#  - Density plots only respond to Site filter
```
...
```{r}
htmltools::HTML("
  Data collected for crew hours, invasive species and biomass removed is summarized for full years. The hours required per cubic metre of biomass shows the labour cost.<br>
  <em>Note: Some missing data for fall 2025</em>")
```
