...
HTML("<strong>Created and Coded for HAT by Wendy Anthony 2026-01-19 06:37</strong>")
...
#  scale_fill_manual(values = custom_colours_3) +
  labs(
      title='Invasive Grass Species Removed - Data Distribution Means, Variance and Outliers',
      fill = "",
      x = "", 
      y = "Biomass Removed (m3)"), 
  tooltip = "text",
