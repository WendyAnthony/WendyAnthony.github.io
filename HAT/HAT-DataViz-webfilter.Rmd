...
Measure distance between or within sites with measuring tool.  
The geolocation map can toggle your location, after permission is given to browser to access location data. Points can be added and saved to the console (right-click map > Inspect > Console > copy coordinates). Also a <a href='https://wendyanthony.github.io/HAT/WebMap/HAT_spatial_site_map_geoloc_draw.html'>Stand-alone Webmap</a>
")
```
