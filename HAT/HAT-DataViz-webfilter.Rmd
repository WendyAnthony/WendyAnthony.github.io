...
HTML("<strong>Created and Coded for HAT by Wendy Anthony 2026-01-25 11:08</strong>")
...
<strong>Density plots</strong> show frequency distribution shape of highest concentration of values (like a smooth histogram); could be used to budget time i.e. how long crews usually spend at each site; only responds to Site filter. <em>Note: There is still some missing data for 2025</em>.  
...
#  geom_line(stat = "identity", position = "identity") +
  ...
  # #b15928 Bear Hill
    #scale_fill_manual(values = custom_colours_3) +
        labs(title='Hours to Remove Biomass by HAT Crew & Volunteers',
          # subtitle='2025',
...
#  geom_line(stat = "identity", position = "identity") +
  ...
  #scale_color_manual(values = c("#b15928","#ffff99","#6a3d9a","#cab2d6","#ff7f00","#33a02c","#a6cee3","#b2df8a", "#cab2d6")) +
   scale_color_manual(values = custom_colours_Site_9) +
        labs(title='Biomass (cubic metres) Removed by HAT Crew & Volunteers',
          # subtitle='2025',
#          caption = "Chart by Wendy Anthony \n 2025-11-29", fill = "Biomass_Removed_m3",
          x = "Date", y = "Biomass Removed (cubic metres)"), 
  tooltip = "text",
  config = (displayModeBar = False) 
  ) %>%
    layout(legend = list(
...
ggplotly(
  ggplot(sd_crew_vol) +
    geom_histogram(bins = 15, aes(x = Crew_Hours, fill = Site), 
                   alpha = 0.5, position = "identity") + 
    labs(title = "Distribution of crew hours worked each site visit",
...
ggplotly(
  ggplot(sd_crew_vol, aes(x = Biomass_Removed_m3)) +
    geom_density(aes(fill = Site, 
                     text = paste0("Frequency of Amount of Biomass Removed: ", sprintf("%.2f", ..density..),
...
ggplotly(
  ggplot(sd_crew_vol) +
    geom_histogram(bins = 15, aes(x = Biomass_Removed_m3, fill = Site), 
                   alpha = 0.5, position = "identity") + 
...
#          xaxis = list(title = "Biomass Removed (cubic metres)"),
#          yaxis = list(title = ""),
...
#         fill = "Year",
#         x = "", 
#         y = "Ratio of Biomass cubic metres Removed per Labour Hour"
#         ), 
#     tooltip = "text",
#   config = (displayModeBar = False) 
#   ) %>%
...
#   theme(legend.position ="bottom") + 
#       labs(
#           title = "Biomass (cubic metres) of Top 5 Invasive Species Cleared", 
#           x = "",   
#           y = "Biomass Removed (cubic metres)",   
#           fill = "Site"
#           ) +
...
#   theme(legend.position ="bottom") + 
#       labs(
#           title = "Biomass cubic metres of All Invasive Species Cleared", 
#           x = "",   
#           y = "Biomass Removed (cubic metres)",   
#           fill = "Site"
#           ) +
...
# ### Datatable Biomass  
# htmltools::h5("Summarized Invasive Biomass Datatable")
# htmltools::br()
...
htmltools::br()
h4("Filtered Statistics")
p(class = "container", class = "value", summarywidget(sd_crew_data_sep_sub_sum_bio_inv_top5, column = "Biomass_Removed_m3", statistic = "sum", digits = 2), span(class = "caption", "= Biomass Removed (cubic metres)"))
p(class = "container", class = "value", summarywidget(sd_crew_data_sep_sub_sum_bio_inv_top5, column = "Crew_Hours", statistic = "sum", digits = 2), span(class = "caption", "= Crew Hours"))
...
```{r}
htmltools::HTML("
Multiple facets compare 8 sites for invasive species biomass removed (Bear Hill didn't differentiate any species from 'mixed species', thus doesn't show). <em>Note: There is still some missing data for 2025</em> 
  ")
```
...
```{r}
htmltools::HTML("
Box plots show variation of biomass removed for top 5 invasive species at each site, including means, variance & outliers (Bear Hill didn't differentiate any species from 'mixed species', thus doesn't show). <em>Note: There is still some missing data for 2025.</em> 
...
ggplotly(
  ...
  scale_fill_manual(values = custom_colours_Site_9) +
  labs(
      title='Distribution Means, Variance & Outliers of Top 5 Invasive Species Removed',
      fill = "",
      x = "", 
      y = "Biomass Removed (cubic metres)"), 
  tooltip = "text",
...
```{r}
htmltools::HTML("
  Cover data was collected using quadrat-sampling methods at Matson in July 2024 and 2025, and at Oak Haven, in April 2024 and 2025. As different seasonal meadows species were sampled, the comparison data between sites may not be as meaningful as if sampled during the same season in different years.")
```
...
ggplotly(
  ...
  theme(legend.position ="bottom") + 
    scale_fill_manual(values = custom_colours_Site_2) +
      labs(
          title = "Native Species Mean % Cover at Oak Haven & Matson", 
          x = "",   
          y = "Mean % cover",   
          fill = "Site"
          ) +
...
ggplotly(
  ...
  scale_fill_manual(values = custom_colours_Site_2) +
  labs(
        title = "Invasive Species Mean % Cover at Oak Haven & Matson",        
        x = "",  
        y = "Mean % cover", 
        fill = "Site" 
      ) +
