...
HTML("
     ...
     <br> * <strong>Original Data</strong>: <em>Restoration Crew Data.xlsx</em>
     <br><br>
     ...
     <br> * <strong>Original Data</strong>: <em>Matson Conservation Area -  Matson Mattocks Field Logs</em>
     <br><br>
     ...
     <br> * <strong>Original Data</strong>: <em>Cover Data 2024-2025</em>
     <br><br>
     
     4. <strong>Site Data</strong> 
     <br> * <strong>Metrics</strong>: Top 5 invasives, Hours per m3 Biomass, staff hours, biomass removed
     <br> * <strong>Sites</strong>: Havenwood, Matson, Oak Haven
     <br> * <strong>Original Data</strong>: <em>https://hat.bc.ca/community-based-restoration</em>
     <br><br>
     ")
```
...
p(class = "container", class = "value", summarywidget(sd_crew, column = "Labour_Bio_Hr_Ratio", statistic = "mean"), span(class = "caption", "= hours of labor/m3 biomass", digits = 2))
p(class = "container", class = "value", summarywidget(sd_crew, column = "Labour_Hr_Bio_Ratio", statistic = "mean"), span(class = "caption", "= m3 biomass/hours of labor", digits = 2))
htmltools::br()
htmltools::hr(style = "border: 0.5px solid grey; width: 250px; margin: auto;")
h4("Filters")
# Create a filter input
...
h4("Filtered Statistics")
#p(class = "container", class = "value", summarywidget(sd_crew_vol, column = "Crew_Hours", statistic = "sum"), span(class = "caption", "= hours of labor"))
p(class = "container", class = "value", summarywidget(sd_crew_vol_inv_top5, column = "Biomass_Removed_m3", statistic = "sum", digits = 2), span(class = "caption", "= Biomass Removed (m3)"))
...
### **Top 5 Invasives Biomass Distribution** 
