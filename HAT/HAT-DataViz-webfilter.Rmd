...
HAT_sites_HAT$Staff_Hours_2022 <- sprintf("%.1f", HAT_sites_HAT$Staff_Hours_2022)
HAT_sites_HAT$Staff_Hours_2023 <- sprintf("%.1f", HAT_sites_HAT$Staff_Hours_2023)
HAT_sites_HAT$Staff_Hours_2024 <- sprintf("%.1f", HAT_sites_HAT$Staff_Hours_2024)
HAT_sites_HAT$Staff_Hours_2025 <- sprintf("%.1f", HAT_sites_HAT$Staff_Hours_2025)
...
filter_checkbox(id = "Municipality", label = "Municipality", sharedData = sd_sites, group = ~Municipality)
# 
...
# HAT IMAGE LOGO
# <img src="https://images.squarespace-cdn.com/content/v1/5e3c5b7e5460c55405a6d4d6/a8c2fb30-96fd-4042-925f-e76c7040dce6/Black+Logo+2.png?format=5w">
     title <- '<p style="text-align: center; height: 14px; "><span style="font-size:12px;font-weight:bold; background-color: rgba(255, 255, 255, 0.9;");>GOE Monitoring Covenant Sites Map</span></p>'
...
leaflet(sd_sites) %>%
    ...
    # Hours per Biomass (m3)
      '<tr style="vertical-align: top;">',
        '<td style="vertical-align: top;"><b>Hours per m3 Biomass:  </b></td>',
    ...
    # Staff Hours
      '<tr style="vertical-align: top;">',
        '<td style="vertical-align: top;"><b>Staff Hours:  </b></td>',
        '<td align="right">', HAT_sites_HAT$Staff_Hours_2022, '</td>',
        '<td align="right">', HAT_sites_HAT$Staff_Hours_2023, '</td>',
        '<td align="right">', HAT_sites_HAT$Staff_Hours_2024, '</td>',
        '<td align="right">', HAT_sites_HAT$Staff_Hours_2025, '</td>',
      '</tr>',
    
    #Biomass Removed (m3)
      '<tr style="vertical-align: top;">',
        '<td style="vertical-align: top;"><b>Biomass Removed (m3):  </b></td>',
      ...
      '</tr>',
    '</table>'
    ## image makes popup window too long and top is missing
    # ,
    # "<br>",
    #         "<figure><span style='text-align: center; font-style:italic; font-size: 9px'><img src = '", HAT_sites_HAT$Site_Image, "'> <figcaption>Image: https://hat.bc.ca/community-based-restoration </figcaption></span></figure>"
