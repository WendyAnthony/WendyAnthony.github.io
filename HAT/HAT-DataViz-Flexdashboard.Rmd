...
htmltools::h3("RNS ER390 Project for Visualizing HAT Monitoring Data")
htmltools::strong("Created and Coded for HAT by Wendy Anthony 2026-01-10")
...
HTML("
  ...
  <h6>Tabs</h6>
  * Each tab in the top header hosts different data visualization charts
  <h6>Data Filters</h6>
  ...
  * data visualization can be focused by dragging a certain area; double-click graph to return to original version<br>
  * if all else fails, refresh webpage in browser
  <h6>Source Code</h6>
  * by default (I actually don't know how to remove it!), a link to the </>SourceCode for this interactive webpage is available in the top header 
  <br><br>
  ")
hr(style = "border: 0.5px solid grey; width: 100%; margin: auto;")
htmltools::br()
HTML("<span style='font-size=65%;'><strong>Contact:</strong> <a href='wanthony@uvic.ca'>Wendy Anthony - wanthony@uvic.ca</a></span>")
```
...
### Mean % Cover - Native Species at Oak Haven & Matson 2024-2025
...
### Mean % Cover - Invasive Species at Oak Haven & Matson 2024-2025
...
### Mean % Cover - Mixed Grasses at Oak Haven & Matson 2024-2025
...
ggplotly(
  ...
  theme(legend.position ="bottom") + 
    ...
    y = "Mean % cover",   # Set the y-axis name
    fill = "Site", 
    #title = "Mixed Grasses Mean % Cover at Oak Haven & Matson 2024-2025"  # Optionally, add a title
  ) +
  theme(axis.text.x = element_text(angle = 0, vjust = 1, hjust=1, size = 7)), 
    tooltip = "text",
  config = (displayModeBar = False) 
...
### Total Biomass Removed to Labor Hours Ratio (Efficiency)
...
### Total Labor Hours to Biomass Removed Ratio (Cost)
  ...
  theme(axis.text.x = element_text(angle = 0, vjust = 1, hjust=1, size = 7)) +
    #scale_fill_manual(values = custom_colours_3) +
        ...
        #   subtitle='HAT Properties',
          # caption = "Chart by Wendy Anthony \n 2025-11-29", 
          fill = "Year",
          x = "", y = "Ratio of Labour Hours per Biomass m3 Removed") +
  theme(axis.text.x = element_text(angle = 0, vjust = 1, hjust=1, size = 7)), 
    tooltip = "text",
  config = (displayModeBar = False) 
  ) %>%
