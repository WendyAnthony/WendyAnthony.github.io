...
HTML("<strong>Created and Coded for HAT by Wendy Anthony 2026-01-12</strong>")
...
htmltools::HTML("<h5>Table Funtionality</h5>
  - Data filters for each table<br>
  - Sort columns using up/down arrows by column name<br>
  - Search table using the search bars<br>
  - Reset filters to delete unwanted choices")
htmltools::br()
htmltools::br()
# Create a filter input
