...
<script>
   $(document).ready(function() {
     $head = $('#header');
     $head.prepend('<img src=\"HAT-FernNewsletter-ss.png\" style=\"float: right;width: 150px;\"/>')
   });
</script>
...
htmltools::HTML("<h5>Data Visualizations</h5>
  ...
  - data visualization can be focused by dragging a certain area; double-click graph to return to original version
")
htmltools::br()
htmltools::br()
...
htmltools::br()
htmltools::br()
htmltools::hr(style = "border: 1px solid black; width: 250px; margin: auto;")
# Create a filter input
...
```{r}
htmltools::hr(style = "border: 1px solid black; width: 100%; margin: auto;")
htmltools::br()
```
...
### <img src='https://images.squarespace-cdn.com/content/v1/5e3c5b7e5460c55405a6d4d6/a8c2fb30-96fd-4042-925f-e76c7040dce6/Black+Logo+2.png?format=5w'> RNS Project for Visualizing HAT Monitoring Data 
```{r}
...
htmltools::strong("Coded by Wendy Anthony 2026-01-10")
htmltools::br()

hr()

HTML("
  <h4>RNS Data Visualization Project</h4>
  ...
  <h4>How to use this interactive data visualization tool</h4>
  <h5>Data Filters</h5>
