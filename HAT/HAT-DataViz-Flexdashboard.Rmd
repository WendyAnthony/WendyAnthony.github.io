...
htmltools::HTML("
  ...
  There is still some missing data for 2025")
```
...
```{r}
htmltools::HTML("
  Cover data was collected using quadrat-sampling methods at Matson in July 2024 and 2025, and at Oak Haven, in April 2024 and 2025. As different seasonal meadows species were sampled, the comparison data may not be as meaningful.")
```
