...
# change column order
crew_data_sep_sub_1 <- crew_data_sep_sub_1[, c("Year", "Date", "Site", "Crew_Hours", "Invasive_Species_Cleared", "Biomass_Removed_m3", "Area_Cleared_m2", "Data_Change_Assumptions")]
...
sd_crew_all <- SharedData$new(data = crew_data_sep_sub_1, group = "crew_all_group")
...
HTML("<strong>Created and Coded for HAT by Wendy Anthony 2026-01-13 @19:40</strong>")
...
```{r crew-hrs-all, echo = FALSE, message = FALSE, warning = FALSE, height = 7}
```

### Biomass Removed 

```{r biomass-all, echo = FALSE, message = FALSE, warning = FALSE, height = 7}
```
...
```{r}
htmltools::HTML("
  At 9 different HAT-managed sites, data was collected for labour hours, invasive species and biomass removed. These charts summarize this data<br>
  <em>Note: There is still some missing data for 2025</em>")
```
