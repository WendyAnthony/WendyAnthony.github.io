...
- I would be prepared to make a presentation to the board to request HAT approval for this ER390 Final Restoration Project if that would be helpful.
...
# Project Objectives (SMART actionable targets)
- See flowchart for work flow (fig.1), and Gantt Chart for proposed timeline (fig.2)
...
- **Create an interactive, web-browser-based Shiny App** for user-chosen, custom-make data visualization plots and maps for selected location(s) and variables, with the ability to save and download the resulting data, html widgets, plot images, and interactive web maps
...
## From RNS
- support and supervision from RNS Nancy Shackelford, particularly before she goes on sabbatical July 2026 

# What I can offer (Include in Email)
- I am a self-motivated, low maintenance, highly independent student, very interested in the natural environment, who loves to continue learning in meaningful ways, and help create useful digital tools to enhance the learning experience.
- I have extensive experience with coding using `R`, especially with data visualization and mapping techniques, often learning new method through self-researched knowledge as the need arose. 
...
- I have already spent more than 30 hours (during August 2025), reviewing and learning the new-to-me R code I would need to complete this project, creating, cleaning, formatting, and filtering example data from a report of the multiple-site Garry Oak Ecosystem monitoring project which was used as a model to help inform Hat's current monitoring project (Malloff & Shackelford, 2024). I feel confident I will be able to learn any other R code as I need to continue to develop a reactive-to-user choice interactive tool, which I have already started as a  demonstration for the still-developing proposed Shiny App idea https://goe-interact.shinyapps.io/Test-Shiny-GOE-Monitor/ , as well as any other code requirement to handle any data visualization needs requested through  consultation with HAT, especially after receiving HAT DATA in order to analyze its structure and formats, and how I might be able to adapt the code I've been developing over the last month. 
- I can also assist HAT with any raw data clean-up as needed, including creating R code for calculating any indices from the measurement data, as well as helping to set-up an RStudio environment so HAT can use the RMarkdown code files I'm developing to see if the user-experience needs any 'tweaks'.

# Project Methods for HAT Data visualization
- See flowchart for work flow (fig.1), and Gantt Chart for timeline (fig.2)
...
\newpage
# Workflow Graph
- The workflow shows how the raw data, from HAT monitoring measurements, is transformed and included in code to produce a variety of deliverable products.
- This graph is made using DiagrammeR code, with a colour-blind friendly colour palette from ColorBrewer
...
# W1[final writeup]
```
fig.1: ER390 Methods Workflow Diagram 

\newpage
# Proposed Timeline (Look at SMART Objectives)
...
```
fig.2: Gantt Proposed ER390 Timeline 
...
```
fig.6: Interactive Leaflet Map with Example Sites Data
\newpage
...
fig.7: Violin / bar plot comparing variables of 2 Subregions
...
ggplotly(plot)
```
fig.8: Point Plot of Restoration Intensity of Example Sites
