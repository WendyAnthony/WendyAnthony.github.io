...
- Analyze, transform, clean data, check for errors, inconsistencies; calculate indices values from raw data **(See [Data Code Example](#data))**
...
- *(See [WorkFlowchart, Figure 1](#workflow), and [Proposed Timeline, Figure 2](#gantt))*; Deliverables created using RStudio
