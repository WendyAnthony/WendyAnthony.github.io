---
title: "TEST Shiny GOE Monitoring DataViz"
...
Creation date: 2025/08/04
 Modified Date & Time: 2025/09/08 @ 06:02  
...
# Percentage_of_native_species <- scales::percent(goe_eccc$Proportion_of_native_species)
...
# goe_eccc_1 <- cbind(goe_eccc, Percentage_of_native_species)
# goe_eccc_1
...
## Data Structure Data
- make sure each column is same data type in both data file   
```{r data-structure-1}
str(goe_eccc)
```
...
```{r random-df-yr2}
goe_eccc_random_2024 <- read.csv("data/TEST-GOE-Monitor-randomChange-diffYear-TEST.csv", header = TRUE, sep = ",")
...
# z<--pmin(-z, z) 
goe_eccc_random_2024$Proportion_of_native_species <--pmin(-goe_eccc_random_2024$Proportion_of_native_species, goe_eccc_random_2024$Proportion_of_native_species) 

goe_eccc_random_2024$Cultural_species_richness <--pmin(-goe_eccc_random_2024$Cultural_species_richness, goe_eccc_random_2024$Cultural_species_richness) 

goe_eccc_random_2024$Exotic_species <--pmin(-goe_eccc_random_2024$Exotic_species, goe_eccc_random_2024$Exotic_species) 

goe_eccc_random_2024$Trampling <--pmin(-goe_eccc_random_2024$Trampling, goe_eccc_random_2024$Trampling) 

goe_eccc_random_2024$Herbivory <--pmin(-goe_eccc_random_2024$Herbivory, goe_eccc_random_2024$Herbivory) 

goe_eccc_random_2024$Composite_Index <--pmin(-goe_eccc_random_2024$Composite_Index, goe_eccc_random_2024$Composite_Index) 

names(goe_eccc_random_2024)
str(goe_eccc_random_2024)
...
goe_eccc_random_2024 %>% mutate_if(is.numeric, round, digits=2) -> goe_eccc_random_2024
...
# goe_eccc_random_2024$Proportion_of_native_species <- pmax(goe_eccc_random_2024$Proportion_of_native_species, 1)
# https://stackoverflow.com/questions/66398854/r-set-column-to-maximum-of-current-entry-and-specified-value-in-an-elegant-way
# data.table version data[foo < 1, foo := 1])
# doesn't work
# goe_eccc_random_2024[goe_eccc_random_2024$Proportion_of_native_species > 1.0000, goe_eccc_random_2024$Proportion_of_native_species == 1.0000]

# change Year back to number
goe_eccc_random_2024$Year <- as.numeric(as.character(goe_eccc_random_2024$Year))
str(goe_eccc_random_2024) 
...
Percentage_ns <- goe_eccc_random_2024$Proportion_of_native_species * 100

# add-new column for Percentages
goe_eccc_random_2024 <- cbind(goe_eccc_random_2024, Percentage_ns)

# arrange order of site names
Sites_eccc_1 <- Sites_eccc %>% arrange(Sites_eccc$Site)
goe_eccc_random_2024_1 <- goe_eccc_random_2024 %>% arrange(goe_eccc_random_2024$Site)
...
goe_eccc_random_2024_sites <- cbind(Sites_eccc_1, goe_eccc_random_2024_1)

# Remove duplicate columns resulting from binding 2 data frames
goe_eccc_random_2024_sites_1 <- goe_eccc_random_2024_sites[c(-9,-10)]

# Rename columns to remove dot-format
names(goe_eccc_random_2024_sites_1)[names(goe_eccc_random_2024_sites_1) == "Land.Manager"] <- "Land_Manager"
names(goe_eccc_random_2024_sites_1)[names(goe_eccc_random_2024_sites_1) == "Main.Restoration.Type"] <- "Main_Restoration_Type"
names(goe_eccc_random_2024_sites_1)[names(goe_eccc_random_2024_sites_1) == "Restoration.Intensity"] <- "Restoration_Intensity"
names(goe_eccc_random_2024_sites_1)[names(goe_eccc_random_2024_sites_1) == "Area.ha"] <- "Area_ha"

# write csv file with combined data 
## to create new data file which is used for creating the visualizations
write.csv(goe_eccc_random_2024_sites_1, "data/goe_eccc_random_2024_all_site_data.csv", row.names = FALSE)
```
</p></details>
...
# names(goe_eccc_sites_1)
# str(goe_eccc_sites_1)
# unique(goe_eccc_sites_1$Restoration_Intensity)
# 
# # change character to factor
# goe_eccc_sites_1$Restoration_Intensity <- as.factor(goe_eccc_sites_1$Restoration_Intensity)
# # change factor to character
# goe_eccc_sites_1 <- data.frame(lapply(goe_eccc_sites_1, as.character), stringsAsFactors=FALSE)
# 
# # WORKS !!!
# Restoration_Intensity_order <- c("high", "moderate", "low", "minimal")
# arranged_goe_eccc_sites_1 <- goe_eccc_sites_1 %>% 
#   arrange(factor(Restoration_Intensity, levels = Restoration_Intensity_order))
# arranged_goe_eccc_sites_1
# str(arranged_goe_eccc_sites_1)
# 
# # still not showing the order
# site_restInt <- ggplot(arranged_goe_eccc_sites_1,
...
print(levels(goe_eccc_sites_2$Restoration_Intensity)) # New order of levels
str(goe_eccc_sites_2)
# step 2
goe_eccc_sites_2 <- goe_eccc_sites_2[order(goe_eccc_sites_2$Restoration_Intensity),]

site_restInt_exotic <- ggplot(goe_eccc_sites_2,
...
#goe_eccc_sites_1$Restoration_Intensity <- factor(goe_eccc_sites_1$Restoration_Intensity, levels = #c("high", "moderate", "low", "minimal"))
str(goe_eccc_sites_1)
...
site_restInt <- ggplot(goe_eccc_sites_2,
...
# values in order now -- ?? how to change to reverse order 
site_restInt_bar <- ggplot(goe_eccc_sites_2,
...
subregion_restInt <- ggplot(goe_eccc_sites_1, 
...
subregion_natsp <- ggplot(goe_eccc_1, 
                    aes(x = Subregion, y = Percentage_ns)) +
                    geom_violin(fill = "seagreen2") +
                    geom_boxplot(width = 0.1, fill = "sandybrown") +
                    theme_minimal() + #get rid of grey background and tick marks 
...
# Anniversary_Island
Anniversary_Island <- goe_eccc_1[1, ]
Anniversary_Island
...
names(goe_eccc_1)
compare_bar_multiple_sites  <-  ggplot(goe_eccc_1,
...
# arrange values
#str(arr)
# goe_eccc_1 %>% arrange(Percentage_ns) -> arr
goe_eccc_1 %>% arrange(desc(Percentage_ns)) %>%
...
# https://r-graph-gallery.com/267-reorder-a-variable-in-ggplot2.html
# View(mpg)
# g <- ggplot(goe_eccc_1, aes(Subregion))  
...
# )
# 
# goe_eccc_2 <- subset(goe_eccc_1, , -c(Subregion))
# 
# goe_eccc_2 %>% rownames_to_column("ID") %>% pivot_longer(!ID) %>%
#   ggplot() +
...
goe_eccc_1_filter <- filter(goe_eccc_1, goe_eccc_1$Site %in% c("Uplands Park", "Trial Island")) 


compare_col_uplands <- ggplot(goe_eccc_1_filter, 
...
goe_eccc <- read.csv("data/SiteData-TEST-GOE-Monitor.csv", header = TRUE, sep = ",", stringsAsFactors=FALSE)
str(goe_eccc)
names(goe_eccc)
...
subregion_var_violin(goe_eccc, 'Plotting Subregion by Exotic_species', 'ECCC Data Paper', goe_eccc$Subregion, goe_eccc$Exotic_species, "Subregion", "Exotic_species", "Chart by Wendy Anthony \n 2025-08-04")
subregion_var_violin(goe_eccc,'Plotting Subregion by Cultural_species_richness', 'ECCC Data Paper', goe_eccc$Subregion, goe_eccc$Cultural_species_richness, "Subregion", "Cultural_species_richness", "Chart by Wendy Anthony \n 2025-08-16")
...
subregion_var_point(goe_eccc,'Plotting Site by Percentage Native Species', 'Malloff & Shackelford. (2024). \nFeeling the Pulse: Monitoring methods and initial outcomes in oak meadow ecosystems. \nRestoration Futures Lab at the University of Victoria.
', goe_eccc$Site, goe_eccc$Proportion_of_native_species, "Site", "Proportion of native species", "Chart by Wendy Anthony \n 2025-09-16 \n ECCC Data: (Malloff & Shackelford, 2024)")

subregion_var_point(goe_eccc,'Plotting Site by Exotic Species', 'Malloff & Shackelford. (2024). \nFeeling the Pulse: Monitoring methods and initial outcomes in oak meadow ecosystems. \nRestoration Futures Lab at the University of Victoria.
', goe_eccc$Site, goe_eccc$Exotic_species, "Site", "Exotic Species", "Chart by Wendy Anthony \n 2025-09-16 \n ECCC Data: (Malloff & Shackelford, 2024)")
```
...
p2 <- subregion_var_point(goe_eccc,'Plotting Site by Percentage Native Species', 'Malloff & Shackelford. (2024). \nFeeling the Pulse: Monitoring methods and initial outcomes in oak meadow ecosystems. \nRestoration Futures Lab at the University of Victoria.
', goe_eccc$Site, goe_eccc$Proportion_of_native_species, "Site", "Proportion of native species", "Chart by Wendy Anthony \n 2025-09-16 \n ECCC Data: (Malloff & Shackelford, 2024)")
...
#goe_eccc_sites <- cbind(goe_eccc, Sites_eccc)
# try to add , "<br>",  "<b>Composite Index:</b> ", goe_eccc_sites$Composite_Index
# names(goe_eccc_sites)
names(Sites_eccc)
...
# https://stackoverflow.com/questions/40137212/variable-marker-size-feature-in-leaflet-r
              radius = ~goe_eccc$Composite_Index * 3,    
...
ECCC_map_1 <- leaflet(goe_eccc_sites_1) %>%
  addProviderTiles("Esri.WorldImagery") %>%
  addCircleMarkers(
             ~ Lng, ~ Lat, 
# https://stackoverflow.com/questions/40137212/variable-marker-size-feature-in-leaflet-r
              radius = ~goe_eccc_sites_1$Composite_Index * 5,    
              # radius = ~goe_eccc_sites_1$Area.ha,
                  # radius = ~sqrt(goe_eccc_sites_1$Area.ha),
 # size smaller is Saanich, else larger if Gulf            
#             radius = ~ifelse(Subregion == "Saanich Peninsula", 4, 5),
    ...
    stroke = TRUE, fillOpacity = 0.5,
             popup = paste0("<b>Site:</b> ", "<b>", "<b>", goe_eccc_sites_1$Site, "</b>", "</b>", "<br><br>", "<b>Subregion:</b> ", goe_eccc_sites_1$Subregion, "<br>",
...
## Gantt Proposed Timeline {#gantt}
- red coloured items are considered critical
- grey items are completed
- Note: Gantt Chart coded with DiagrammeR using imported csv file of data, but no colour or size control
### Sep 2025 - Aug 2026
```{r gantt-x, echo=FALSE, include=TRUE, message=FALSE}
ER390_gantt <- read.csv("data/ER390-Gantt-Tasks.csv", header = TRUE, sep = ",")
# str(ER390_gantt)
...
Figure 2: Gantt Proposed ER390 Timeline, Sep 2025-Jul 2026 

\newpage

### Sep-Dec, 2025
```{r gantt-s1, echo=FALSE, include=TRUE, message=FALSE}
ER390_gantt_1 <- read.csv("data/ER390-Gantt-Tasks-s1.csv", header = TRUE, sep = ",")
# str(ER390_gantt)
# NOTE: dates need to be chr in order for Gantt code to work properly
# names(ER390_gantt)
# # convert start and end dates from chr to date 
...
mermaid(
  paste0(
    ...
    "gantt", "\n",
    "dateFormat  YYYY-MM-DD", "\n",
    "title ER390 HAT Data Viz Project Proposed Timeline Sep-Dec, 2025", "\n",
    # unite the first two columns (task & status) and separate them with ":"
    # then, unite the other columns and separate them with ","
    # this will create the required mermaid "body"
    paste(ER390_gantt_1 %>%
...
Figure 2.1: Gantt Proposed ER390 Timeline Sep-Dec, 2025

\newpage

### Jan-Apr 2026 

```{r gantt-s2, echo=FALSE, include=TRUE, message=FALSE}
ER390_gantt_2 <- read.csv("data/ER390-Gantt-Tasks-s2.csv", header = TRUE, sep = ",")
# str(ER390_gantt)
# NOTE: dates need to be chr in order for Gantt code to work properly
# names(ER390_gantt)
# # convert start and end dates from chr to date 
...
mermaid(
  paste0(
    ...
    "gantt", "\n",
    "dateFormat  YYYY-MM-DD", "\n",
    "title ER390 HAT Data Viz Project Proposed Timeline Jan-Apr 2026", "\n",
    # unite the first two columns (task & status) and separate them with ":"
    # then, unite the other columns and separate them with ","
    # this will create the required mermaid "body"
    paste(ER390_gantt_2 %>%
...
Figure 2.2: Gantt Proposed ER390 Timeline, Jan-Apr 2026 

\newpage

### May-Jul, 2026

```{r gantt-s3, echo=FALSE, include=TRUE, message=FALSE}
ER390_gantt_3 <- read.csv("data/ER390-Gantt-Tasks-s3.csv", header = TRUE, sep = ",")
# str(ER390_gantt)
# NOTE: dates need to be chr in order for Gantt code to work properly
# names(ER390_gantt)
# # convert start and end dates from chr to date 
...
mermaid(
  paste0(
    ...
    "gantt", "\n",
    "dateFormat  YYYY-MM-DD", "\n",
    "title ER390 HAT Data Viz Project Proposed Timeline May-Jul, 2026", "\n",
    # unite the first two columns (task & status) and separate them with ":"
    # then, unite the other columns and separate them with ","
    # this will create the required mermaid "body"
    paste(ER390_gantt_3 %>%
...
Figure 2.3: Gantt Proposed ER390 Timeline May-Jul, 2026
...
lmGadget(goe_eccc_1, "Percentage_ns", "Composite_Index")
...
ui <-shinyUI(fluidPage(
  selectInput("Box1","Choose a Subregion", choices = c("All",unique(goe_eccc$Subregion))),
  selectInput("Box2","Choose an Site", choices = c("All",unique(goe_eccc$Site))),
  tableOutput("table1")
...
server <- shinyServer(function(input,output, session){
  ...
  data1 <- reactive({
    if(input$Box1 == "All"){
      ...
      goe_eccc[which(goe_eccc$Subregion == input$Box1),]
    }
  })
  ...
  data2 <- reactive({
    if (input$Box2 == "All"){
      ...
      goe_eccc[which(goe_eccc$Site == input$Box2),]
    }
  })
  ...
  observe({
    ...
    if(input$Box1 != "All"){
      ...
      updateSelectInput(session,"Box2","Choose an Site", choices = c('All',unique(goe_eccc$Site)))
      updateSelectInput(session,"Box1","Choose a Subregion", choices = c('All',unique(goe_eccc$Subregion)))
    }
  })
  ...
  data3 <- reactive({
    if(input$Box2 == "All"){
      ...
      goe_eccc[which(goe_eccc$Site== input$Box2 & goe_eccc$Subregion == input$Box1),]
    }
  })
...
goe_eccc_sites <- read.csv("data/goe_eccc_all_site_data.csv", header = TRUE, sep = ",")
names(goe_eccc_sites)
str(goe_eccc_sites)
...
ui <- fluidPage(
  ...
  tags$div(HTML('<p style="font-size:12px;"><b>Note:</b> Marker size is based on Composite Index.</p>')),
    ...
    selectInput(
      "Subregion_filter",
      "Select Subregion:",
      choices = c("All" = "all", unique(goe_eccc_sites$Subregion)),
      selected = "all"
    ),
  tags$div(HTML('<p style="font-size:12px;">Note: If selecting by Subregion,
    ...
    selectInput(
      "Site_filter",
      "Select Site:",
      choices = c("All" = "all", unique(goe_eccc_sites$Site)),
      selected = "all"
  ),
...
goe_eccc <- read.csv("data/goe_eccc_all_site_data.csv", header = TRUE, sep = ",", stringsAsFactors=FALSE)
...
server <- function(input, output) {
  ...
  mc <- goe_eccc # could be reactive in real world case
