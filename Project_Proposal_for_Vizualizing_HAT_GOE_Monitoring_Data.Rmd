...
# Background
- Data used for this proposal is from the report that HAT used as a model for their GOE Monitoring Project (Malloff & Shackelford, 2024)
- use data to represent data in a visual manner,

# Project Partner
- I have already spoken to Vanessa Brownlee, Habitat Restoration Coordinator, Habitat Acquisition Trust (HAT) on 2025-08-27
...
- Mermaid Flow Chart for Methods
...
# Display map
ECCC_map_2
saveWidget(ECCC_map_2, "ECCC_map_2.html")
```
