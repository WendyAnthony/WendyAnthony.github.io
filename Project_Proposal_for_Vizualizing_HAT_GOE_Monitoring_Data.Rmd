...
- see Gantt Chart for timeline, and DiagrammeR flowchart for work flow
...
- Create RMarkdown documents to automatically download and format data, create data visualizations, and produce reports for the whole project and individual sites.
...
- Create an interactive, browser-based Shiny app for user-chosen, custom-make data visualization plots and maps for selected location(s) and variables, with the ability to save and download the resulting data, html widgets, plot images, and interactive web maps
...
- (see Gantt Chart for proposed timeline and Mermaid 
Flow Chart for Methods Workflow)
...
- (see Gantt Chart for proposed timeline and Mermaid 
Flow Chart for Methods Workflow)
- All of the following will be created using RStudio
...
#  style P fill:#E5E25F, stroke:#333, stroke-width:1px  
#  style R fill:#E5E25F, stroke:#333, stroke-width:1px  
#  style RP fill:#E5E25F, stroke:#333, stroke-width:1px  
#  style S fill:#E5E25F, stroke:#333, stroke-width:1px  
#  style V fill:#E5E25F, stroke:#333, stroke-width:1px  
#  style W fill:#E5E25F, stroke:#333, stroke-width:1px  
# 
# ")
# # #3C8937 Forest Green
...
W(Written Report)
 ...
 style A3 fill:#dff5f0, stroke:#333, stroke-width:2px  
 style A fill:#c3faca, stroke:#333, stroke-width:3px  
 style C fill:#c3faca, stroke:#333, stroke-width:1px  
 style D fill:#ddfac3, stroke:#333, stroke-width:3px  
 style D1 fill:#c3faca, stroke:#333, stroke-width:1px  
 style D2 fill:#E5E25F, stroke:#333, stroke-width:1px  
 style D3 fill:#E5E25F, stroke:#333, stroke-width:1px  
 style D4 fill:#E5E25F, stroke:#333, stroke-width:1px  
  ...
  style E fill:#ddfac3, stroke:#333, stroke-width:3px  
 style F fill:#cdd9c3
 style IA fill:#E5E25F, stroke:#333, stroke-width:1px  
 style K fill:#E5E25F, stroke:#333, stroke-width:2px  
 style P fill:#E5E25F, stroke:#333, stroke-width:1px  
 style R fill:#E5E25F, stroke:#333, stroke-width:1px  
 style RP fill:#E5E25F, stroke:#333, stroke-width:1px 
 style RT fill:#E5E25F, stroke:#333, stroke-width:1px  
 style S fill:#E5E25F, stroke:#333, stroke-width:1px  
 style V fill:#E5E25F, stroke:#333, stroke-width:1px  
 style W fill:#E5E25F, stroke:#333, stroke-width:1px  
...
## Load Site Data
<details><summary><b><i>Click to see R code for `Loading Data`</i></b></summary><p>
```{r, load-data}
...
<details><summary><b><i>Click to see R code for `Data Cleaning and Transformation`</i></b></summary><p>
```{r, data-cleaning}
# create new column with percentages as whole number
Percentage_ns <- geo_eccc$Proportion_of_native_species * 100
