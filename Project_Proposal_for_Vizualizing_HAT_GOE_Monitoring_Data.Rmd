...
- Create random ECCC 2nd year test data for creating multi-year, multi-project comparisons
...
Figures 3,4,5: Example Data Table Formats, with Head showing only first 6 rows.
...
- Data (Malloff & Shackelford, 2024) is summarized in map marker popups with summary of site data
