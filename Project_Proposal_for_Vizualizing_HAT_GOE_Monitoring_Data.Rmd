...
# Project Partner
- I have already spoken to Vanessa Brownlee, Habitat Restoration Coordinator at Habitat Acquisition Trust (HAT) on 2025-08-27, who was very interested in my proposed project idea, and seemed willing to consider letting me start in Fall 2025.
...
- Create scaleable data visualization tools that can have more sites added, with different measuring and sensitivity criteria (e.g. First Nations GOE sites).
- Track differences between sites: e.g. native species, exotic invasive species, etc.
- Create custom R functions for reading, analyzing, and plotting data. 
